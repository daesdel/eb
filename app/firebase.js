    ...
    import { getFirestore, collection, addDoc, query, where } from "https://www.gstatic.com/firebasejs/10.1.0/firebase-firestore.js"
    ...
    export const obtenerDocumento = (coleccion, id) => {
      const ingRef = collection (db, id);
      query (ingRef, where ("IRJira", "==", id));
    }
